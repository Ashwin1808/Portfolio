...
/**
 * The devops ∞ — kept as a reference, hidden for now.
 * One continuous figure-eight, the stack flowing around it without
 * end. Restore it inside the hero when the moment is right:
...
/**
 * 01 — The opening, in space. The name behind everything, a strong
 * line, two doors. The sky is already there — the atmosphere holds it.
 */
export function HomeHero() {
  ...
  return (
    ...
    >
      {/* the name — behind everything, quiet */}
      <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 top-[6%] z-0 text-center">
        <p className="text-stroke select-none font-serif text-[clamp(8rem,24vw,21rem)] leading-[0.85] tracking-[-0.03em] text-cream/[0.09]">
          ASHWIN
        </p>
      </div>
      ...
      <div className="wrap relative z-10 w-full pb-16 pt-32 sm:pt-36">
        ...
        >
          ...
          >
            ...
            {/* the devops ∞ — the reference, the loop itself is hidden */}
            <motion.div
              variants={rise}

...
import { stackNodes, rideMatchPipeline } from "@/data/journey";
...
function Pipeline() {
  ...
  return (
    <div className="relative">
      {/* one thin line + one moving signal */}
      ...
      <div className="mt-6 flex min-h-[44px] items-baseline gap-3 border-t border-dark-line pt-5" aria-live="polite">
...
/**
 * Part 03 — Now. "Currently building."
 * The DevOps system, then RideMatch as proof.
 */
      ...
      <div className="wrap py-24 sm:py-32">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-end">
          <div className="lg:col-span-7">
            <p className="font-mono text-[10.5px] uppercase tracking-[0.24em] text-accent">03 — Now</p>
          ...
          <p className="max-w-[380px] text-[13.5px] leading-[1.8] text-muted lg:col-span-5 lg:justify-self-end">
            Not a list of skills — a system I&apos;m actually running. Touch a node.
          </p>
        </div>
        ...
        <div className="mt-20 border-t border-line pt-12">
          <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
            <div>
              <p className="font-mono text-[9.5px] uppercase tracking-[0.22em] text-faint">Flagship project</p>
          ...
          <div className="mt-10">
            <p className="mb-6 font-mono text-[9px] uppercase tracking-[0.24em] text-faint">
              From commit to dashboard — hover a stage
            </p>
            <Pipeline />
          </div>
        </div>
